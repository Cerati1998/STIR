<div x-data="dataEdit">
    <form wire:submit="save">
        ...
        <x-wire-modal-card title="Datos de Transportista" name="transportModal" wire:model="openModal" width="3xl">
    ...
    @push('js')
        <script>
             function dataEdit() {
                return {
                    //transport: @entangle('transport').live,
