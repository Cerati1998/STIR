<x-dashboard-layout title="Descargas | {{ session('company')->razonSocial }}" :breadcrumbs="[
    ...
    <x-wire-alert class="mb-4" title="Ojo! Recuerda eliminar la fila de ejemplo de la plantilla antes de agregar tu información. Esto evitará errores en la carga masiva."
        warning />
