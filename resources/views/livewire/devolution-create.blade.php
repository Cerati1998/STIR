<div>
    <div x-data="devolutionsCreate">
        <form wire:submit="save">

            <x-wire-modal-card title="Subida masiva de contenedores" name="devolutionCreate" wire:model="openModal"
